...
package bits_types_u_mbstate_t_h is
   ...
   type anon_2(discr: unsigned := 0) is record
      case discr is
         ...
         when others =>
            uu_wchb: aliased uu_mbstate_t_uu_wchb_array;  -- /usr/include/bits/types/__mbstate_t.h:19
      end case;
   end record;
   ...
   type uu_mbstate_t is record
      ...
      uu_value: aliased anon_2;  -- /usr/include/bits/types/__mbstate_t.h:20
   end record;
   pragma Convention(C_Pass_By_Copy,
      uu_mbstate_t);  -- /usr/include/bits/types/__mbstate_t.h:21
