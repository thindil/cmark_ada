...
package bits_types_h is
  ...
  -- Type of file system IDs.   
   ...
   type uu_fsid_t is record
      uu_val : aliased uu_fsid_t_uu_val_array;  -- /usr/include/bits/types.h:155
   end record
  ...
  -- The type of a disk address.   
   subtype uu_daddr_t is int;  -- /usr/include/bits/types.h:164

  -- Type of an IPC key.   
   subtype uu_key_t is int;  -- /usr/include/bits/types.h:165

  -- Clock ID used in clock and timer functions.   
   subtype uu_clockid_t is int;  -- /usr/include/bits/types.h:168

  -- Timer ID returned by `timer_create'.   
   type uu_timer_t is new System.Address;  -- /usr/include/bits/types.h:171

  -- Type to represent block size.   
   subtype uu_blksize_t is long;  -- /usr/include/bits/types.h:174

  -- Types from the Large File Support interface.   
  -- Type to count number of disk blocks.   
   subtype uu_blkcnt_t is long;  -- /usr/include/bits/types.h:179

   subtype uu_blkcnt64_t is long;  -- /usr/include/bits/types.h:180

  -- Type to count file system blocks.   
   subtype uu_fsblkcnt_t is unsigned_long;  -- /usr/include/bits/types.h:183

   subtype uu_fsblkcnt64_t is unsigned_long;  -- /usr/include/bits/types.h:184

  -- Type to count file system nodes.   
   subtype uu_fsfilcnt_t is unsigned_long;  -- /usr/include/bits/types.h:187

   subtype uu_fsfilcnt64_t is unsigned_long;  -- /usr/include/bits/types.h:188

  -- Type of miscellaneous file system fields.   
   subtype uu_fsword_t is long;  -- /usr/include/bits/types.h:191

  -- Type of a byte count, or error.   
   subtype uu_ssize_t is long;  -- /usr/include/bits/types.h:193

  -- Signed long type used in system calls.   
   subtype uu_syscall_slong_t is long;  -- /usr/include/bits/types.h:196

  -- Unsigned long type used in system calls.   
   subtype uu_syscall_ulong_t is unsigned_long;  -- /usr/include/bits/types.h:198

  -- These few don't really vary by system, they always correspond
  --   to one of the other defined types.   

  -- Type of file sizes and offsets (LFS).   
   subtype uu_loff_t is uu_off64_t;  -- /usr/include/bits/types.h:202

   type uu_caddr_t is new Interfaces.C.Strings.chars_ptr;  -- /usr/include/bits/types.h:203

  -- Duplicates info from stdint.h but this is used in unistd.h.   
   subtype uu_intptr_t is long;  -- /usr/include/bits/types.h:206

  -- Duplicate info from sys/socket.h.   
   subtype uu_socklen_t is unsigned;  -- /usr/include/bits/types.h:209

  -- C99: An integer type that can be accessed as an atomic entity,
  --   even in the presence of asynchronous interrupts.
  --   It is not currently necessary for this to be machine-specific.   

   subtype uu_sig_atomic_t is int;  -- /usr/include/bits/types.h:214
